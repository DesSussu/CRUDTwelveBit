    ...
    <div class="w-100">
        ...
        <div class="row p-4 d-flex justify-content-center">
            <div class="col-lg-4 col-md-6 col-10 p-5 d-flex flex-column align-items-center contenedor">
                ...
                <?php if ($row) { ?>
                <form action="controllers/proveedoresController.php?accion=editar" method="POST" class="d-flex flex-column align-items-center mt-1">
                    ...
                    <div class="mt-3">
                        <input type="text" id="direccion" name="direccion" placeholder="Dirección" value="<?php echo $row['Direccion']; ?>" required>
                    </div>
                    <div class="mt-3">
